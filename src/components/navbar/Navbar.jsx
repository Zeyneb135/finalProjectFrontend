        ...
        <div className={style.navbar}>
            <div className={style.navs}>
                ...
                <div className={style.login}>
                    <li><FaRegHeart /><a href="/wishlist">Favorites</a></li>
                    <li><RxDashboard /><a href="*">Dashboard</a></li>

                    {user ? (
                        <div className={style.userSection}>
                            <p className={style.welcomeText}>Welcome, {user.otherDetails.username}!</p>
                ...
                <div className={style.burger}>
                    ...
                    <Drawer open={isOpen} onClose={() => setIsOpen(false)} direction='right'>
                        <div className={style.burgerMenu}>
                            ...
                            {user ? (
                                <div className={style.userSection}>
                                    <p>Welcome, {user.otherDetails.username}!</p>
